      ...
      <div class="sidebar-content">
        <ul class="nav nav-secondary">
          <li class="nav-section">
            ...
            <h4 class="text-section">Lapangan</h4>
          </li>
  ...
  <div class="main-panel">
    ...
    <div class="container">
      <div class="page-inner">
        ...
        >
          <div>
            <h3 class="fw-bold mb-3">Lapangan</h3>
                            ...
                            <tbody>
                                @forelse ($lapangan as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('lapangan/' . $item->id . '/edit') }}" class="btn btn-primary btn-sm">Edit</a>
                                            <form action="{{ url('lapangan/' . $item->id) }}" method="post" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus?')">
                                                @method('delete')
                                                @csrf
