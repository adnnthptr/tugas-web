  ...
  <div class="main-panel">
    ...
    <div class="container">
      <div class="page-inner">
        ...
        >
          <div>
            <h3 class="fw-bold mb-3">Tambah Lapangan</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('lapangan', []) }}" method="POST">
                            @csrf
        
                            <!-- Nama Lapangan -->
                            <div class="form-group">
                                <label for="nama_lapangan">Nama Lapangan</label>
                                <input id="nama_lapangan" class="form-control" type="text" name="nama_lapangan" value="{{ old('nama_lapangan') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="kapasitas" class="form-control" type="number" name="kapasitas" value="{{ old('kapasitas') }}">
