                            ...
                            <tbody>
                                @forelse ($administrasi as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge text-bg-{{ $item->status_pembayaran == 'Lunas' ? 'success' : 'warning' }}">
                                        ...
                                        <td>
                                            <a href="{{ url('administrasi/' . $item->id . '/edit') }}" class="btn btn-primary btn-sm">Edit</a>
                                            <form action="{{ url('administrasi/' . $item->id) }}" method="post" class="d-inline" onsubmit="return confirm('Apakah Dihapus?')">
                                                @method('delete')
                                                @csrf
                                ...
                                @empty
                                    <tr>
                                        <td colspan="12" class="text-center">Tidak ada data administrasi.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
