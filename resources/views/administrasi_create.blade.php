                    ...
                    <div class="card-body">
                        <form action="{{ url('administrasi', []) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama_pelanggan" class="form-control" type="text" name="nama_pelanggan" value="{{ old('nama_pelanggan') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="nomor_telepon" class="form-control" type="text" name="nomor_telepon" value="{{ old('nomor_telepon') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="tanggal_reservasi" class="form-control" type="date" name="tanggal_reservasi" value="{{ old('tanggal_reservasi') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="waktu_mulai" class="form-control" type="time" name="waktu_mulai" value="{{ old('waktu_mulai') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="waktu_selesai" class="form-control" type="time" name="waktu_selesai" value="{{ old('waktu_selesai') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="biaya" class="form-control" type="number" step="0.01" name="biaya" value="{{ old('biaya') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status_pembayaran" class="form-control" name="status_pembayaran">
                                    <option value="Belum Dibayar" @selected(old('status_pembayaran') == 'Belum Dibayar')>Belum Dibayar</option>
