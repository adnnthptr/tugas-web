                    ...
                    <div class="card-body">
                        <form action="{{ url('pelanggan/' . $pelanggan->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama" class="form-control" type="text" name="nama" value="{{ old('nama', $pelanggan->nama) }}">
                                <span class="text-danger">{{ $errors->first('nama') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input id="email" class="form-control" type="email" name="email" value="{{ old('email', $pelanggan->email) }}">
                                <span class="text-danger">{{ $errors->first('email') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="no_telepon">Nomor Telepon</label>
                                <input id="no_telepon" class="form-control" type="text" name="no_telepon" value="{{ old('no_telepon', $pelanggan->no_telepon) }}">
                                <span class="text-danger">{{ $errors->first('no_telepon') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <input id="alamat" class="form-control" type="text" name="alamat" value="{{ old('alamat', $pelanggan->alamat) }}">
                                <span class="text-danger">{{ $errors->first('alamat') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="kode_lapangan">Kode Lapangan</label>
                                <input id="kode_lapangan" class="form-control" type="text" name="kode_lapangan" value="{{ old('kode_lapangan', $pelanggan->kode_lapangan) }}">
                                <span class="text-danger">{{ $errors->first('kode_lapangan') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="jumlah_jam">Jumlah Jam yang Dimainkan</label>
                                <input id="jumlah_jam" class="form-control" type="number" name="jumlah_jam" value="{{ old('jumlah_jam', $pelanggan->jumlah_jam) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" class="form-control" name="status">
                                    <option value="aktif" @selected($pelanggan->status == 'aktif')>Aktif</option>
                                    <option value="non-aktif" @selected($pelanggan->status == 'non-aktif')>Non-Aktif</option>
                                </select>
