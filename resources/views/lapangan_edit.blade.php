...
<style>
  body {
      background-image: url('{{ asset('/lite/assets/img/MC.png') }}');
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('lapangan/' . $lapangan->id) }}" method="post">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama_lapangan" class="form-control" type="text" name="nama_lapangan" value="{{ old('nama_lapangan', $lapangan->nama_lapangan) }}">
                                <span class="text-danger">{{ $errors->first('nama_lapangan') }}</span>
                            </div>
        
                            <!-- Kapasitas -->
                            <div class="form-group">
                                <label for="kapasitas">Kapasitas</label>
                                <input id="kapasitas" class="form-control" type="number" name="kapasitas" value="{{ old('kapasitas', $lapangan->kapasitas) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" class="form-control" name="status">
                                    <option value="aktif" @selected($lapangan->status == 'aktif')>Aktif</option>
                                    <option value="non-aktif" @selected($lapangan->status == 'non-aktif')>Non-Aktif</option>
                                </select>
