...
<style>
  body {
      background-image: url('{{ asset('/lite/assets/img/WC.png') }}');
              ...
              <ul class="nav nav-collapse">
                ...
                <li>
                  <a href="{{ url('Lapangan/laporan/cetak', []) }}">
                    <span class="sub-item">Lapangan</span>
                  </a>
                </li>
              </ul>
            </div>
                    ...
                    <div class="card-body">
                        <form action="{{ url('administrasi/' . $administrasi->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama_pelanggan" class="form-control" type="text" name="nama_pelanggan" value="{{ old('nama_pelanggan', $administrasi->nama_pelanggan) }}">
                                <span class="text-danger">{{ $errors->first('nama_pelanggan') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="nomor_telepon">Nomor Telepon</label>
                                <input id="nomor_telepon" class="form-control" type="text" name="nomor_telepon" value="{{ old('nomor_telepon', $administrasi->nomor_telepon) }}">
                                <span class="text-danger">{{ $errors->first('nomor_telepon') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input id="email" class="form-control" type="email" name="email" value="{{ old('email', $administrasi->email) }}">
                                <span class="text-danger">{{ $errors->first('email') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="tanggal_reservasi">Tanggal Reservasi</label>
                                <input id="tanggal_reservasi" class="form-control" type="date" name="tanggal_reservasi" value="{{ old('tanggal_reservasi', $administrasi->tanggal_reservasi) }}">
                                <span class="text-danger">{{ $errors->first('tanggal_reservasi') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="waktu_mulai">Waktu Mulai</label>
                                <input id="waktu_mulai" class="form-control" type="time" name="waktu_mulai" value="{{ old('waktu_mulai', $administrasi->waktu_mulai) }}">
                                <span class="text-danger">{{ $errors->first('waktu_mulai') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="waktu_selesai">Waktu Selesai</label>
                                <input id="waktu_selesai" class="form-control" type="time" name="waktu_selesai" value="{{ old('waktu_selesai', $administrasi->waktu_selesai) }}">
                                <span class="text-danger">{{ $errors->first('waktu_selesai') }}</span>
                            </div>
        
                            <div class="form-group">
                                <label for="biaya">Biaya</label>
                                <input id="biaya" class="form-control" type="number" step="0.01" name="biaya" value="{{ old('biaya', $administrasi->biaya) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status_pembayaran" class="form-control" name="status_pembayaran">
                                    <option value="Belum Dibayar" @selected($administrasi->status_pembayaran == 'Belum Dibayar')>Belum Dibayar</option>
                                    <option value="Lunas" @selected($administrasi->status_pembayaran == 'Lunas')>Lunas</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="catatan" class="form-control" name="catatan">{{ old('catatan', $administrasi->catatan) }}</textarea>
